...
```
docker pull omicschef/epigenomechef:hg19v1.0.0-beta
```

HOMER mouse (mm10)対応 (required storage size: 17Gb)
```
docker pull omicschef/epigenomechef:mm10v1.0.0-beta
```
...
HOMER human (hg19)対応 
```
docker run --rm -p 3838:3838 omicschef/epigenomechef:hg19v1.0.0-beta
```
HOMER mouse (mm10)対応 
```
docker run --rm -p 3838:3838 omicschef/epigenomechef:mm10v1.0.0-beta
```

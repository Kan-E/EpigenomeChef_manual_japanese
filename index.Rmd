...
（例1：A_1 有、A_2 有、B_1 無、B_2 無 → reproducible、例2：A_1 無、A_2 無、B_1 有、B_2 有 → reproducible、例2：A_1 有、A_2 無、B_1 無、B_2 有 → NOT reproducible）
ALL peaks: ピークコールされた全ての領域をカウント化します。
